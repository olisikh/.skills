...
- Claude-specific first-party skill sources live in `~/.llm-harness/harness/claude/skills/` and install to `~/.claude/skills`.
- Portable first-party skill sources live in `~/.llm-harness/harness/agents/skills/` and install to `~/.agents/skills`.
